            ...
            <div className="bg-white dark:bg-gray-700 rounded-2xl p-6 sm:p-8 shadow-xl">
              ...
              <div className="space-y-4">
                <motion.a
                  ...
                  className="flex items-center gap-4 p-4 bg-amber-50 dark:bg-amber-900/20 rounded-xl hover:bg-amber-100 dark:hover:bg-amber-900/30 transition-colors group"
                  whileHover={{ scale: 1.02 }}
                  transition={{ type: "spring", stiffness: 400, damping: 17 }}
                  aria-label="Send me an email"
                >
                  <div className="w-12 h-12 bg-amber-500 rounded-xl flex items-center justify-center group-hover:bg-amber-600 transition-colors">
                  ...
                  <div>
                    ...
                    <div className="text-amber-600 dark:text-amber-400">moinkhan.jsx@gmail.com</div>
                  </div>
                </motion.a>
                ...
                >
                  <div className="w-12 h-12 bg-amber-500 rounded-xl flex items-center justify-center group-hover:bg-amber-600 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" className="w-6 h-6 text-white" aria-hidden="true">
                  ...
                  <div>
                    ...
                    <div className="text-amber-600 dark:text-amber-400">github.com/moinkhanjsx</div>
                  </div>
                </motion.a>
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-amber-600 dark:text-amber-400">linkedin.com/in/your-linkedin</div>
                  </div>
                </motion.a>
              </div>
            </div>
              ...
              <form className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    id="name"
                    name="name"
                    className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-transparent bg-white dark:bg-gray-800 text-gray-900 dark:text-white transition-colors"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    name="message"
                    rows="4"
                    className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-transparent bg-white dark:bg-gray-800 text-gray-900 dark:text-white transition-colors resize-none"
                ...
                <motion.button
                  type="submit"
                  className="w-full bg-amber-600 text-white py-3 px-6 rounded-xl font-semibold hover:bg-amber-700 transition-colors focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2"
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  transition={{ type: "spring", stiffness: 400, damping: 17 }}

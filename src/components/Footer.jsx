    ...
    <footer className="bg-gray-900 dark:bg-gray-800 text-white py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          ...
          >
            <h3 className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-amber-600 to-amber-400 bg-clip-text text-transparent mb-4">
              Moin Khan
            </h3>
          ...
          >
            <h4 className="text-base sm:text-lg font-semibold mb-4 text-amber-400">Quick Links</h4>
              ...
              {["Home", "About", "Projects", "Skills", "Contact"].map((item, index) => (
                ...
                >
                  <a
                    ...
                    className="text-gray-300 hover:text-amber-400 transition-colors duration-200 text-xs sm:text-sm"
                    onClick={(e) => {
                      e.preventDefault();
          ...
          >
            <h4 className="text-base sm:text-lg font-semibold mb-4 text-amber-400">Connect</h4>

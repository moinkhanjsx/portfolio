      ...
      >
        <div className={`w-80 h-60 ${isDarkMode ? 'bg-gray-900 border-gray-700' : 'bg-white border-gray-200'} border-2 rounded-xl overflow-hidden shadow-2xl backdrop-blur-sm`}>
          ...
          <div className="relative h-[calc(100%-50px)]">
            {isLoading && (
              <div className={`absolute inset-0 ${isDarkMode ? 'bg-gray-800' : 'bg-gray-100'} flex items-center justify-center`}>
                <div className="text-center">
                  <div className="animate-spin w-6 h-6 border-2 border-purple-500 border-t-transparent rounded-full mx-auto mb-2"></div>
                  <p className={`text-xs ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>Loading...</p>
                </div>
              </div>
            )}
            ...
            {hasError && (
              <div className={`absolute inset-0 ${isDarkMode ? 'bg-gray-800' : 'bg-gray-100'} flex items-center justify-center`}>
                <div className="text-center p-4">
                  ...
                  <p className={`text-xs ${isDarkMode ? 'text-gray-300' : 'text-gray-700'} mb-2`}>
                    Preview blocked
                  </p>
                  <p className={`text-xs ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>

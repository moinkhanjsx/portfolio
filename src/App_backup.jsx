...
function App() {
  ...
  return (
    <div className={`min-h-screen ${theme.bg} ${theme.text} overflow-x-hidden transition-all duration-500`}>
      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 pt-16 overflow-hidden">
        <div className="text-center max-w-6xl mx-auto relative z-10">
          <div className="mb-8 sm:mb-16">
            ...
            <h2 className={`text-3xl sm:text-4xl md:text-6xl lg:text-8xl font-bold mb-6 sm:mb-10 ${theme.text} leading-tight bg-gradient-to-r ${isDarkMode ? 'from-white via-gray-100 to-white' : 'from-gray-900 via-gray-700 to-gray-900'} bg-clip-text text-transparent`} data-aos="fade-up" data-aos-delay="200">
              Full-Stack Developer
            </h2>
            
            <div className="relative" data-aos="fade-up" data-aos-delay="400">
              <p className={`text-lg sm:text-xl md:text-2xl lg:text-3xl ${theme.textSecondary} mb-8 sm:mb-16 max-w-4xl mx-auto leading-relaxed font-light px-4 sm:px-0`}>
                Crafting <span className="text-purple-400 font-semibold">extraordinary</span> digital experiences with <span className="text-cyan-400 font-semibold">cutting-edge</span> technology and <span className="text-pink-400 font-semibold">innovative</span> solutions that push the boundaries
              </p>
      ...
      <section id="skills" className="py-16 sm:py-24 lg:py-32 px-4 sm:px-6 relative z-10">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 lg:mb-24" data-aos="fade-up">
            ...
            <p className={`text-lg sm:text-xl ${theme.textMuted} max-w-2xl mx-auto px-4 sm:px-0`}>
              Mastering the latest technologies to build extraordinary digital experiences
            </p>
      ...
      <section id="contact" className="py-16 sm:py-24 lg:py-32 px-4 sm:px-6 relative z-10 overflow-hidden">
        <div className="max-w-6xl mx-auto text-center relative">
          ...
          <div className="mb-12 sm:mb-16 lg:mb-20">
            <h2 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-black mb-4 sm:mb-6 lg:mb-8 bg-gradient-to-r from-purple-400 via-pink-500 to-cyan-400 bg-clip-text text-transparent animate-text-glow">
              Let's Create Magic
            </h2>
